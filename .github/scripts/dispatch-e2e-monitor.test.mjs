...
test('buildDispatchInputs pins the immutable action ref and smoke suite', () => {
  assert.deepEqual(buildDispatchInputs({ action: 'postman-resolve-service-token-action', refName: 'v2.1.6', suite: 'smoke' }), {
    action: 'postman-resolve-service-token-action',
    ref: 'v2.1.6',
    suite: 'smoke'
  });

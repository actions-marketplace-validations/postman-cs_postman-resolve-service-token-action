...
- npm package: [@postman-cs/onboarding-resolve-service-token](https://www.npmjs.com/package/@postman-cs/onboarding-resolve-service-token); sample workflows: [postman-service-account-onboarding-sample](https://github.com/postman-cs/postman-service-account-onboarding-sample)
